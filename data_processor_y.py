...
base_dir = '/content/drive/MyDrive/drought_monitor/data_proc'
output_dir = os.path.join(base_dir, 'data_proc')
os.makedirs(output_dir, exist_ok=True)
x_path = os.path.join(base_dir, 'dataset_X_2022.pt')
y_path = os.path.join(output_dir, 'dataset_Y_2022.pt')
