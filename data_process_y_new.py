...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--input_dir', type=str, default='/root/autodl-tmp/zyk_drought_monitor/data')
    parser.add_argument('--output_dir', type=str, default='/root/autodl-tmp/zyk_drought_monitor/data')
